...
describe('UncontrolledForm Component', () => {
  ...
  // it('renders all uncontrolled inputs correctly', () => {
  ...
  //   expect(screen.getByRole('button', { name: /Submit/i })).toBeEnabled(); // Always enabled on uncontrolled
  // });
  ...
  //         name: 'Alice',
  //         age: 30, // Parsed into integer inside logic
